...
public class testing
{
   ...
   public static void main(String[] args)
   {
      ...
      /*지도 만드는 좌표를 mpoint로 연결*/
		...
		red.AddPoint(new mpoint(527,146), false);
		...
		purple.AddPoint(new mpoint(489,310), false);
		...
		green.AddPoint(new mpoint(633,354), false);
		...
		Darkgreen.AddPoint(new mpoint(454,569), false);
